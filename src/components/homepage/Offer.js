      ...
      <Grid container sx={{ maxWidth: '100vw !important' }}>
        <Grid item md={6} xs={12} sx={{ p: 2 }}>
          <Typography variant="body1" lineHeight={2} sx={{ textAlign: 'justify' }}>
            {' '}
            Наша кампанія враховує останні світові тенденції і приєднується до загального напрямку на розвиток відтворюваної «зеленої» енергії. Наші партнери –
            найкваліфікованіші виробники обладнання в ЄС, які виробляють і проводять селекцію обладнання для інсталяції у господарствах кінцевих споживачів. Ми
            розглянемо вашу заявку, вивчимо енергоємність господарства, розробимо технологічну карту, змонтуємо та проведемо пускові-налагоджувальні роботи.
            Наша продукція має гарантію до 10 років і закріплюється контрактом.
          </Typography>
